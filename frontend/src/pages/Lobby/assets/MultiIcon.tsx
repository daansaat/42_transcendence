    ...
    return (
        ...
        >
                ...
                <g>
                    <path 
                        style={{fill:"#B2D7FF"}} 
                        d="M386.613,278.015H106.937c22.017,41.52,59.13,72.31,103.147,83.471l-12.68,78.717 c-4.897,30.4,18.579,57.96,49.371,57.96l0,0c30.791,0,54.266-27.559,49.371-57.958l-12.68-78.717 C327.484,350.324,364.597,319.535,386.613,278.015z"
                        >
                    </path>
                    <circle 
                        style={{fill:"#B2D7FF"}}
            ...
            <svg style={{position: "absolute", top: 20, right: 40}}
                height="100px"
                width="100px"
                version="1.1"
                id="Layer_1" 
